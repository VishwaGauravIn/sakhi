        ...
        <div className="flex flex-col">
          ...
          >
            ...
            >
              ...
              <AccordionContent>
                Menstruation is commonly known as a period. When you menstruate,
                your uterus lining sheds and flows out of your vagina. Your
                period contains blood, mucus and some cells from the lining of
                your uterus. The average length of a period is three to seven
                days. Sanitary pads, tampons, period underwear or menstrual cups
                can be used to absorb your period. Pads and tampons need to be
                changed regularly (preferably every three to four hours) and
                menstrual cups should be changed every eight to 12 hours.
              </AccordionContent>
            </AccordionItem>
            {/* Follicular Phase */}
            <AccordionItem
            ...
            >
              ...
              <AccordionContent>
                ...
                lasts for 13 to 14 days, ending in ovulation. The pituitary
                gland in the brain releases a hormone to stimulate the
                production of follicles on the surface of an ovary. Usually,
                only one follicle will mature into an egg. This can happen from
                day 10 of your cycle. During this phase, your uterus lining also
            ...
            >
              ...
              <AccordionContent>
                ...
                to get pregnant in the five days before ovulation and on the day
                of ovulation, but it’s more likely in the three days leading up
                to and including ovulation. Once the egg is released, it will
                survive up to 24 hours. If sperm reaches the egg during this
                time, you may get pregnant.
              </AccordionContent>
            </AccordionItem>
            {/* Luteal Phase */}
            <AccordionItem
            ...
            >
              ...
              <AccordionContent>
                ...
                progesterone and a small amount of oestrogen. This causes the
                lining of the uterus to thicken in preparation for pregnancy. If
                a fertilised egg implants in the lining of the uterus, the
                corpus luteum continues to produce progesterone, which maintains
                the thickened lining of the uterus. If pregnancy does not occur,
                the corpus luteum dies, progesterone levels drop, the uterus
